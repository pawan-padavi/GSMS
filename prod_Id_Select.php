<?php
    include('config.php');
    $q = "SELECT product.p_name,product.p_id FROM product LEFT OUTER JOIN product_quantity ON product.p_id=product_quantity.p_id WHERE product_quantity.p_id IS NULL";
