...
{
    $output="<table class='table table-sm'><tr><th colspan='4' class='text-danger bg-warning'>DISPATCED PRODUCT STATUS</th></tr>
    <tr><td>PRODUCT</td><td>QUANTITY</td><td>DISPATCHED</td><td>DELIVERED</td></tr>";
